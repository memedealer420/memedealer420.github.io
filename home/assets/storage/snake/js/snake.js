        ...
        me.handleDeath = function() {
            function recordScore () {
                ...
                if (me.snakeLength > highScore) {
                    ...
                    $('.game-over').html('<div class="new-high-score" style="font-size:20px;color:#FFF;"><span class="congratulations">New High Score</span></div><div class="high-score"><span class="you-got-new-high-score">yeet</span><img="css/images/wow.gif"></div>');
                } else {
                    //if not show regular play again screen
                    $('.game-over').html("<img src='css/images/wasted.png' height='100px' width='300px'>");
                }
            }
            recordScore();
            ...
            jQuery(".high-score-block").html("Best: " + highScore); //update high score in game
            isDead = true;
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "Best: " + highScore; //display high score block
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "<p class='game-over'>GAME OVER</p><p class='score-text'>Length: <span id='score-text-number'>" + myId +"</span> </p>"; //display score
        ...
        */ 
        me.setupPlayingField = function () {
            ...
            if (config.fullScreen === true) {
                ...
                document.body.style.backgroundColor = "#16324c";
            } else {
                cTop = config.top;
                cLeft = config.left;
                cWidth = config.width;
...
function getHighScore () {
    $('high-score').html(localStorage.jsSnakeHighScore + ' is your best');
